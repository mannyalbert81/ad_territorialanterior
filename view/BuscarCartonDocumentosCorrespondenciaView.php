...
<html lang="es">
     <head>
        <meta charset="utf-8"/>
        <title>Cor - Cartones de Documentos - aDocument 2015</title>
    ...
    <div class="container">
      ...
      <form action="<?php echo $helper->url("Documentos","BuscaxCartonCorrespondencia"); ?>" method="post" class="col-lg-3">
	    ...
	    <table class="table">
	         <tr>
	    		...
	    		<th style="color:#456789;font-size:80%;" >Numero de Documento</th>
	    	    <th style="color:#456789;font-size:80%;" >Asunto</th>
	   			<th style="color:#456789;font-size:80%;" >Nombre remitente</th>
	   			<th style="color:#456789;font-size:80%;" >Nombre destinatario</th>
	   			<th style="color:#456789;font-size:80%;" >Nombre control</th>
	   			<th style="color:#456789;font-size:80%;" >Paginas</th>
		    ...
		    <?php  $numero_carton_documentos = 0; ?>
	  		<?php if ($resultSet !="") { foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <?php $numero_carton_documentos =  $res->numero_carton_documentos; ?>     
					   <td style="color:#456789;font-size:80%;"> <?php echo $res->asunto_documentos_legal; ?>     </td> 						   
						<td style="color:#456789;font-size:80%;"> <?php echo $res->nombre_remitente_documentos_legal; ?>     </td>
						<td style="color:#456789;font-size:80%;"> <?php echo $res->nombre_destinatario_documentos_legal; ?>     </td>
		        ...
		        <?php } ?>
					...
					<tr> 
				         <td>
			           		<div class="right">
			                    <a href="<?php echo $helper->url("Documentos","ReportexCartonCorrespondencia"); ?>&numero_carton_documentos=<?php echo $numero_carton_documentos; ?>" class="btn btn-info"  target="blank"  >Imprimir Reporte</a>
			                </div>
			             </td>
