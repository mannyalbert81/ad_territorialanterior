...
<html lang="es">
     <head>
        <meta charset="utf-8"/>
        <title>Cartones de Documentos Tarjetas - aDocument 2015</title>
    ...
    <div class="container">
      ...
      <form action="<?php echo $helper->url("Documentos","BuscaxCartonTarjetas"); ?>" method="post" class="col-lg-3">
		    ...
		    <?php  $numero_carton_documentos = 0; ?>
	  		<?php if ($resultSet !="") { foreach($resultSet as $res) {?>
	        		<tr>
		               ...
		               <?php $numero_carton_documentos =  $res->numero_carton_documentos; ?>     
					   <td style="color:#456789;font-size:80%;" > <?php echo $res->numero_tarjetas; ?>     </td> 						   
